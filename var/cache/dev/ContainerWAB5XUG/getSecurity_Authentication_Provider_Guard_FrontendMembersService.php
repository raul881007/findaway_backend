...
// Returns the private 'security.authentication.provider.guard.frontend_members' shared service.
...
return $this->privates['security.authentication.provider.guard.frontend_members'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
...
}, 1), ($this->privates['security.user.provider.concrete.member_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_MemberProviderService.php')), 'frontend_members', ($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())), ($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php')));
