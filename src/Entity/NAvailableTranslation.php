...
/**
 * @ORM\Table(name="navailable_translation", uniqueConstraints={
 *     @ORM\UniqueConstraint(
 *          name="navailable_language_translatable_idx",
 *          columns={
 *              "language_id",
 *              "translatable_id"
 *          }
 *     )
 * })
 * @ORM\Entity(repositoryClass="App\Repository\NAvailableTranslationRepository")
...
class NAvailableTranslation
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\NAvailable", inversedBy="translations")
     * @Assert\NotBlank()
     */
    ...
    public function getTranslatable(): NAvailable
    {
        return $this->translatable;
    }

    public function setTranslatable(NAvailable $translatable): self
    {
