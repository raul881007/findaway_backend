...
/**
 * @ORM\Table(name="ntask_translation", uniqueConstraints={
 *     @ORM\UniqueConstraint(
 *          name="ntask_language_translatable_idx",
 *          columns={
 *              "language_id",
 *              "translatable_id"
 *          }
 *     )
 * })
 * @ORM\Entity(repositoryClass="App\Repository\NTaskTranslationRepository")
...
class NTaskTranslation
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\NTask", inversedBy="translations")
     * @Assert\NotBlank()
     */
    ...
    public function getTranslatable(): NTask
    {
        return $this->translatable;
    }

    public function setTranslatable(NTask $translatable): self
    {
