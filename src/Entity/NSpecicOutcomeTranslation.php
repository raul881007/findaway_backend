...
/**
 * @ORM\Table(name="nspecic_outcome_translation", uniqueConstraints={
 *     @ORM\UniqueConstraint(
 *          name="nspecic_outcome_language_translatable_idx",
 *          columns={
 *              "language_id",
 *              "translatable_id"
 *          }
 *     )
 * })
 * @ORM\Entity(repositoryClass="App\Repository\NSpecicOutcomeTranslationRepository")
 ...
 * )
 */
class NSpecicOutcomeTranslation
{
    use Timestampable;
    use Blameable;
    use IsActive;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\NSpecicOutcome", inversedBy="translations")
     * @Assert\NotBlank()
     */
    ...
    public function getTranslatable(): NSpecicOutcome
    {
        return $this->translatable;
    }

    public function setTranslatable(NSpecicOutcome $translatable): self
    {
