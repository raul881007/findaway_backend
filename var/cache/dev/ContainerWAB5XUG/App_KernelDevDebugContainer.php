...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 5 => ($this->privates['security.authentication.provider.guard.frontend_members'] ?? $this->load('getSecurity_Authentication_Provider_Guard_FrontendMembersService.php'));
            yield 6 => ($this->privates['security.authentication.provider.guard.frontend_partner'] ?? $this->load('getSecurity_Authentication_Provider_Guard_FrontendPartnerService.php'));
            yield 7 => ($this->privates['security.authentication.provider.guard.frontend_supervisor'] ?? $this->load('getSecurity_Authentication_Provider_Guard_FrontendSupervisorService.php'));
            yield 8 => ($this->privates['security.authentication.provider.anonymous.frontend'] ?? ($this->privates['security.authentication.provider.anonymous.frontend'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
            yield 9 => ($this->privates['security.authentication.provider.dao.docs'] ?? $this->load('getSecurity_Authentication_Provider_Dao_DocsService.php'));
            yield 10 => ($this->privates['security.authentication.provider.guard.api'] ?? $this->load('getSecurity_Authentication_Provider_Guard_ApiService.php'));
        }, 11), true);
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.frontend_members' => ['privates', 'security.firewall.map.context.frontend_members', 'getSecurity_Firewall_Map_Context_FrontendMembersService.php', true],
            ...
            'security.firewall.map.context.frontend_members' => '?',
            ...
            yield 'security.firewall.map.context.frontend_members' => ($this->privates['.security.request_matcher.A55mH35'] ?? ($this->privates['.security.request_matcher.A55mH35'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/frontend/members')));
