...
// Returns the private 'annotated_app_entity_supervisor_api_platform_core_bridge_doctrine_orm_filter_order_filter' shared autowired service.
...
return $this->privates['annotated_app_entity_supervisor_api_platform_core_bridge_doctrine_orm_filter_order_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\OrderFilter(($this->services['doctrine'] ?? $this->getDoctrineService()), NULL, 'order', ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ['id' => NULL, 'firstname' => NULL, 'email' => NULL, 'description' => NULL, 'createdAt' => NULL, 'updatedAt' => NULL], ($this->privates['serializer.name_converter.metadata_aware'] ?? $this->getSerializer_NameConverter_MetadataAwareService()));
